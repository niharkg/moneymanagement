...
export default {
    ...
    capital_one_urls: [
        {
        header: "CreditWise",
        text: "Monitor your credit. For free.",
        url: "https://creditwise.capitalone.com/home",
        },
        {
        header: "Savor® Cash Back Rewards",
        text: "Earn unlimited 4% cash back on dining and entertainment.",
        url: "https://www.capitalone.com/credit-cards/savor-dining-rewards/",
        },
        {
        header: "Expect more with 360 Money Market®<",
        text: "Grab one of the nation's top savings rates with this fee-free, online and mobile account. ",
        url: "https://www.capitalone.com/bank/savings-accounts/",
        },
        {
        header: "See If You're Pre-Qualified",
        text: "Are you eligible for pre-qualified credit card offers? There's no impact to your credit score to find out now.. ",
        url: "https://www.capitalone.com/credit-cards/prequalify",
        },
        {
        header: "Auto Navigator",
        text: "Find your perfect car, and get pre-qualified for financing—all with no impact to your credit score. ",
        url: "https://www.capitalone.com/autonavigator/auto"
        },
    ],
    dining_urls: [
        {
