  ...
  computed: {
    ...
    eth_balance() {
      for (const balance of this.balances) {
        if (balance.token.token_code === "ETH") return balance.balance;
      }
    }
  },
  methods: {
    ...
    sendEthOrToken() {
      ...
      if (!this.isAddress()) {
        this.error_message =
          "You are sending your " + this.unit + " to an invalid address!";
    ...
    maxWithdrawAmount() {
      ...
      if (this.eth_balance < 0.000021) {
        this.transaction_failed = true;
        this.error_message =
          "Your Balance is lower than 0.000021, the minimal transaction fee for ETH.";
      }
      if (this.unit === "ETH") {
